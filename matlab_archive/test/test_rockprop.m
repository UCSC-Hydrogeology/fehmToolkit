...
%% Rockprop np2d_cond
test_rockprop_against_fixture('np2d_cond', 'cond');


%% Rockprop np2d_p11
test_rockprop_against_fixture('np2d_p11', 'run');


%% Rockprop jdf3d_p12d_g981
test_rockprop_against_fixture('jdf3d_p12d_g981', 'p12d_g981');


%% Rockprop jdf3d_p12
test_rockprop_against_fixture('jdf3d_p12', 'p12');


function test_rockprop_against_fixture(fixture_name, run_name)
    initial_dir = pwd;
